...
RENAME_MAP = {
    ...
    'crack_s4':            'Crack Última Semana (0-7)',
    'crack_s3':            'Crack Semana 3 (0-7)',
    'crack_s2':            'Crack Semana 2 (0-7)',
    'crack_s1':            'Crack Semana 1 (0-7)',
    'crack_total':         'Crack Total (0-28)',
    'crack_prom':          'Crack Promedio/día',
    'metanfetamina_s4':    'Metanfetamina Última Semana (0-7)',
    'metanfetamina_s3':    'Metanfetamina Semana 3 (0-7)',
    'metanfetamina_s2':    'Metanfetamina Semana 2 (0-7)',
    'metanfetamina_s1':    'Metanfetamina Semana 1 (0-7)',
    'metanfetamina_total': 'Metanfetamina Total (0-28)',
    'metanfetamina_prom':  'Metanfetamina Promedio/día',
    'heroina_s4':          'Heroína Última Semana (0-7)',
    'heroina_s3':          'Heroína Semana 3 (0-7)',
    'heroina_s2':          'Heroína Semana 2 (0-7)',
    'heroina_s1':          'Heroína Semana 1 (0-7)',
    'heroina_total':       'Heroína Total (0-28)',
    'heroina_prom':        'Heroína Promedio/día',
    'otra_sust_s4':        'Otra Sustancia Última Semana (0-7)',
    'otra_sust_s3':        'Otra Sustancia Semana 3 (0-7)',
    'otra_sust_s2':        'Otra Sustancia Semana 2 (0-7)',
    'otra_sust_s1':        'Otra Sustancia Semana 1 (0-7)',
    'otra_sust_total':     'Otra Sustancia Total (0-28)',
    'otra_sust_prom':      'Otra Sustancia Promedio/día',
    'otra_sust_nombre':    'Otra Sustancia (nombre)',
    'otra_sust_unidad':    'Otra Sustancia (unidad)',
    'hurto':               'Hurto',
    'robo':                'Robo',
...
if st.session_state.get('rol_centro'):
    ...
    from pipeline.panel.reportes_centro import render as _render_reportes_centro

    tab_inicio, tab_segu, tab_rep_centro = st.tabs(['🏠 Inicio', '🚦 Seguimientos', '📊 Reportes'])
    with tab_inicio:
        _render_kpis(df_centro, centro_actual, pais_actual, df_pais_raw)
    with tab_segu:
...
with tab_panel:
    ...
    if df_panel.empty:
        ...
        # ── Layout: Ranking (col izq, alto) | Seguimiento + Semáforo (col der) ──
        col_rk, col_der = st.columns(2, gap='small')
        with col_rk:
...
async function guardarCambios() {
  ...
  const tv = id => { const el = document.getElementById(id); return el ? (isNaN(parseInt(el.textContent))?null:parseInt(el.textContent)) : null; };
  ...
  const payload = {
    ...
    salud_psicologica: parseInt(document.querySelector('input[name="salud_psicologica"]:checked')?.value ?? 'NaN'),
    ...
    salud_fisica: parseInt(document.querySelector('input[name="salud_fisica"]:checked')?.value ?? 'NaN'),
    vivienda_estable: toggleValues.vivienda_estable,
    vivienda_basica: toggleValues.vivienda_basica,
    calidad_vida: parseInt(document.querySelector('input[name="calidad_vida"]:checked')?.value ?? 'NaN')
  };
  ...
  try {
    ...
    if (!resp.ok) {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        mostrarToast('⚠ La operación no modificó ningún registro. Verifique permisos o vuelva a intentarlo.', 'error');
      }
    }
  } catch(e) {
